...
void rk6Solve(int steps, double t, atg_scs::SystemState *state) {
    atg_scs::Rk6OdeSolver solver;
...
TEST(Rk6OdeSolverTests, Rk6OdeSolverSanity) {
    atg_scs::Rk6OdeSolver solver;
...
TEST(Rk6OdeSolverTests, Rk6OdeSolverIntegrate1Step) {
    atg_scs::Rk6OdeSolver solver;
    atg_scs::SystemState state;
...
TEST(Rk6OdeSolverTests, Rk6OdeSolverIntegrate100Steps) {
    atg_scs::Rk6OdeSolver solver;
    atg_scs::SystemState state;
