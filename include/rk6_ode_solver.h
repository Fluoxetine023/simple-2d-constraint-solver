#ifndef ATG_SIMPLE_2D_CONSTRAINT_SOLVER_RK6_ODE_SOLVER_H
#define ATG_SIMPLE_2D_CONSTRAINT_SOLVER_RK6_ODE_SOLVER_H

#include "ode_solver.h"

namespace atg_scs {
class Rk6OdeSolver : public OdeSolver {
public:
    enum class RkStage {
        Stage_1,
        Stage_2,
